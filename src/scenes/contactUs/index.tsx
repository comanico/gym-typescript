        ...
        <div className="mt-10 justify-between gap-8 md:flex">
          ...
          >
            <form
              target="_blank"
              onSubmit={onSubmit}
              action="https://formsubmit.co/comaniciu.alex@yahoo.com"
              method="POST"
            >
              <input type="text" 
          ...
          >
            <div className="md:before:content-evolvetext w-ful before:absolute before:-bottom-20 before:-right-10 before:z-[-1]">
